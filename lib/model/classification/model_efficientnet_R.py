...
from lib.model.classification import registerClsModels
...
@registerClsModels('efficientnet_b0')
...
@registerClsModels('efficientnet_b1')
...
@registerClsModels('efficientnet_b2')
...
@registerClsModels('efficientnet_b3')
...
@registerClsModels('efficientnet_b4')
...
@registerClsModels('efficientnet_b5')
...
@registerClsModels('efficientnet_b6')
...
@registerClsModels('efficientnet_b7')
